...
const Cancelled = ({missedappointments}) => {
const navigation = useNavigation()
    ...
    return (
        ...
        {
            missedappointments.length > 0  ? missedappointments.map((item)=>(
             <View key={item._id} style={{ gap: 16 }}>
                ...
                <TouchableOpacity onPress={()=>navigation.navigate('CancelledPage',{item:item})} style={{ backgroundColor: '#1F51C6', borderRadius: 74, width: '100%', paddingVertical: 15, justifyContent: 'center', alignItems: 'center' }}>
            ...
            <View style={{ borderWidth: 0.5, borderColor: '#D9D9D980', marginBottom:15, borderStyle: 'dashed' }}></View>
                ...
                <Text>No Cancelled or missed Appointments</Text>
            </View>
        }
        </View>
