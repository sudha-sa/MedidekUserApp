...
const LabTests = () => {
    const [selectBiotee, setSelectBiotee] = useState([1, 2, 3, 4, 5, 6, 7,8])
                ...
                <ScrollView style={{}}>
                    {
                        selectBiotee.map((item) => (
                            <TouchableOpacity onPress={()=>navigation.navigate('PathLabs')} key={item} style={{ gap: 16, marginBottom: 12, }}>
                                ...
                                <View style={{ flexDirection: 'row', gap: 15, }}>
                                    ...
                                    <View style={{ gap: 3 }}>
                                        <Text style={{ color: '#353535', fontSize: 16, fontWeight: '600' }}>Vitamin D test</Text>
