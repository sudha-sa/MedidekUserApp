...
const PathLabs = () => {
    ...
    const [tests, setTests] = useState([1, 2, 3, 4, 5, 6])
                ...
                <View style={{ margin: 10, gap: 16 }}>
                    ...
                    <View onPress={() => navigation.navigate("MedicalDetails")} style={{ borderWidth: 1, borderColor: '#D9D9D980', borderRadius: 5, padding: 16, gap: 12, flexDirection: 'row' }}>
                        ...
                        <View style={{ width: '70%' }}>
                            ...
                            <Text style={{ color: '#706D6D', fontSize: 13, fontWeight: '500', }}>114 Ratings</Text>
                        </View>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', gap: 8 }}>
                        <TouchableOpacity onPress={() => setSelectPage(0)} style={{ backgroundColor: selectPage == 0 ? '#1F51C6' : '#FFFFFF', borderRadius: 50, borderWidth: 1, borderColor: '#D9D9D961', paddingVertical: 11, paddingHorizontal: 28 }}>
                            <Text style={{ color: selectPage == 0 ? '#FFFFFF' : '#5D5E61BD', fontSize: 13, fontWeight: '500', textAlign: 'center' }}>Tests</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setSelectPage(1)} style={{ backgroundColor: selectPage == 1 ? '#1F51C6' : '#FFFFFF', borderRadius: 50, borderWidth: 1, borderColor: '#D9D9D961', paddingVertical: 11, paddingHorizontal: 28 }}>
                            <Text style={{ color: selectPage == 1 ? '#FFFFFF' : '#5D5E61BD', fontSize: 13, fontWeight: '500', textAlign: 'center' }}>Reviews</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={() => setSelectPage(2)} style={{ backgroundColor: selectPage == 2 ? '#1F51C6' : '#FFFFFF', borderRadius: 50, borderWidth: 1, borderColor: '#D9D9D961', paddingVertical: 11, paddingHorizontal: 28 }}>
                            <Text style={{ color: selectPage == 2 ? '#FFFFFF' : '#5D5E61BD', fontSize: 13, fontWeight: '500', textAlign: 'center' }}>About</Text>
                        </TouchableOpacity>
                    </View>
...

                    {
                        selectPage == 0 && reviews.map((item) => (
                            <View key={item} style={{ borderWidth: 1, borderColor: '#D9D9D980', borderRadius: 5, padding: 16, gap: 12, flexDirection: 'row' }}>
                                <Image source={require("../../assets/Rectangle1758.png")} resizeMode='contain' style={{ width: 90, height: 90, borderRadius: 5 }} />
                                <View style={{ width: '70%' }}>

                                    <Text style={{ color: '#263238', fontSize: 13, fontWeight: '500', }}>TSH (Thyroid Simulating Hormone)</Text>
                                    <Text style={{ color: '#706D6D', fontSize: 13, fontWeight: '600' }}><FontAwesome name='rupee' size={11} color={"#706D6D"} /> 500  (₹520) <Text style={{ color: '#13A407' }}> 20% off</Text></Text>
                                    <Text style={{ color: '#706D6D', fontSize: 13, fontWeight: '600', }}>Get reports in 24 hrs</Text>
                                    <TouchableOpacity style={{ backgroundColor: '#1F51C6', paddingVertical: 10, marginTop: 10, borderRadius: 25, width: 100 }}>
                                        <Text style={{ color: '#FFFFFF', fontSize: 13, fontWeight: '500', textAlign:'center'}}>Book</Text>
                                    </TouchableOpacity>
                                </View>
                            </View>
                        ))
